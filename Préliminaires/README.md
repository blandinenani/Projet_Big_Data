Les trois fonctions préliminaires nous ont aidé à visualiser la structure de la donnée (avec structure.py et print.py) et à commencer à l'exploiter (avec read.py).
